...
(def-doom-theme j--doom-rouge
  ...
  ((bg         '("#172030" nil       nil            )) ;; modified
   ...
   (selection      base4)
   (builtin        light-red)
   (comments       (if doom-rouge-brighter-comments blue grey))
   (doc-comments   green)
   (constants      red)
   (functions      salmon)
   (keywords       magenta)
  ...
  (((font-lock-comment-face &override) :slant 'italic)
   ...
   (magit-diff-revision-summary :foreground fg :background dark-blue :extend t)
   (magit-diff-revision-summary-highlight :foreground fg :background blue :extend t)
