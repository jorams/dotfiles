;;; my-darktooth-theme.el --- Modification of darktooth
...
(deftheme my-darktooth "Modification of darktooth")

(let ((darktooth-dark0_hard      (if (display-graphic-p) "#1D2021" "color-234"))
  ...
  (custom-theme-set-faces
   ...
   ;; UI
   `(default                            ((t (:foreground ,darktooth-light2 :background ,darktooth-dark0_hard))))
   ...
   `(fringe                             ((t (:foreground ,darktooth-light4 :background ,darktooth-dark0_hard))))
   ...
   ;; Built-in syntax
   `(font-lock-builtin-face             ((t (:foreground ,darktooth-neutral_green))))
...
(provide-theme 'my-darktooth)

;;; my-darktooth-theme.el ends here
